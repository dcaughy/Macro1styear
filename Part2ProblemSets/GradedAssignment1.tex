...
\[\iff \beta=\eta(\lambda)\]
This is the same Hosios condition that we saw in class. The intuition is that the efficient solution depends on the elasticity of the matching function. If this matches the elasticity or bargaining power of the firm in the market equilibrium, then the market outcome will be efficient. The two optimality conditions coincide 
